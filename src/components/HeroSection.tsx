...
export default function HeroSection() {
  const [vaporTextError, setVaporTextError] = useState(false);
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      <div className="flex flex-col items-center text-center z-10 max-w-4xl mx-auto px-4">
        ...
        {!vaporTextError ? (
          <ErrorBoundary 
            onError={() => setVaporTextError(true)}
            fallback={
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 md:mb-8 animate-fade-in">
                Engaja Pro
              </h1>
            }
          >
